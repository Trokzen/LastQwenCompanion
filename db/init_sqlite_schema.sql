...
CREATE TABLE IF NOT EXISTS actions (
    ...
    selected_organizations TEXT,                       -- JSON массив ID организаций
...
-- === ТАБЛИЦА ДЛЯ СВЯЗИ ФАЙЛОВ ОРГАНИЗАЦИЙ С МЕРОПРИЯТИЯМИ ===

-- Таблица для привязки файлов организаций к конкретным мероприятиям
